...
imageFile_1 = 'saranajnormalnije.jpg';
...
def regionsOfInterest(detectedObj, imageObj, hAdd = 0, hDiv = 1, wAdd = 0, wDiv = 1):
    ...
    return regionOfInterestObjects;
"""
def calculateFaceCenterPointX(detectedFaceObj):
    (rectX,rectY,rectWidth,rectHeight) = detectedFaceObj[0];
    calculatedFaceCenterPointX = rectX + rectWidth/2;
    return calculatedFaceCenterPointX
"""
...
#Detected faces and ROI on corrected images
...
regionOfInterestMiddleColorObjectsCorr = regionsOfInterest(detectedFacesCorr, correctedImageObj, 0.4, 1.4, 0.33, 1.5);
regionOfInterestMiddleGrayObjectsCorr = regionsOfInterest(detectedFacesCorr, correctedImageGrayObj, 0.4, 1.4, 0.33, 1.5);
...
cv2.circle(regionOfInterestColorObjectsCorr[0], eyeMiddlePoint, 5, (255,255,255), -1);

#print calculateFaceTilt(eyesCenterPoints, detectedFaces, regionOfInterestColorObjects);
